...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Chroma.wav',			'chroma',			'Logo Artist',											'https://youtu.be/dQw4w9WgXcQ',								'90649c'],
			['teles',				'teles',			'Composer of the mod',									'https://youtube.com/channel/UCHK83AQBjAc9sy0lE6m8e3A',		'ff6ca7'],
			['RllySilly',			'silly',			'Composer of the mod',									'https://www.youtube.com/channel/UCHxBPN16QCa7Y6X6RWHEhlg',	'8b7fde'],
			['Anakim',				'anakim',			'Composer of the mod',									'https://youtube.com/channel/UCHC1W3nZ1nVhaN2QrS-O4sg'	,	'8a7ee4'],
			['JulianoBeta',			'juliano',			'Composer of the mod',									'https://www.youtube.com/channel/UCRDeljMur0lEz1nXhrFKE9A',	'241D4A'],
			[''],
			['Psych Engine Team'],
